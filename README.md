...
- 7,227 条**安全证据索引**；
- 全球公开来源有界恢复、存量公开完整性终审和持续发现准入后的 1,323 条岗位记录：1,205 条已核实岗位、118 条高概率岗位；
- 969 条经 2026-08-06 正式复核、从全部 1,323 条唯一处置直接投影并通过十项 Current 硬门的严格当前岗位；
- 新岗位建议、纠错、定期复核、降级、替代和回滚的维护工具。

> 重要：7,227 是历史证据行数，不是当前岗位数、招聘人数或市场规模。本项目也不承诺实时或绝对完整。
