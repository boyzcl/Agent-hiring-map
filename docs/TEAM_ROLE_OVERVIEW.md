...
共有 522 个不同的原始 `role_family` 标签。它们粒度不统一，因此不直接当作高层分类；下表保留最常见标签，完整值仍在岗位数据中。

| 原始岗位族标签 | 地图岗位记录 |
| --- | ---: |
| agent_algorithm_or_research_role | 55 |
| agent_engineering_or_application_role | 44 |
| agent_engineer_or_applied_ai_engineer | 28 |
| agent_engineer_platform_or_infrastructure | 26 |
| agent_or_ai_product_management_role | 25 |
| agent_algorithm_research | 25 |
| agent_product_manager | 24 |
| agent_engineer | 22 |
| agent_infra_engineer | 20 |
| agent_research_training_or_evaluation_role | 19 |
| agent_security_evaluation_governance_or_response_role | 15 |
| agent_platform_or_application_architect_role | 14 |
| agent_operations_delivery_or_management_role | 14 |
| agent_algorithm_engineer | 13 |
| coding_agent_or_developer_product_role | 13 |
| qualification_or_functional_agent_boundary | 12 |
| vertical_agent_algorithm_research | 12 |
| agent_adjacent_qualification_or_ai_workflow_boundary | 12 |
| agent_algorithm_or_platform_engineering | 11 |
| agent_eval_test_or_quality_role | 11 |
| agent_product_team_adjacent_or_boundary_role | 10 |
| current_exact_agent_specific_official_role | 10 |
| agent_research_scientist_or_algorithm_engineer | 10 |
| agent_hiring_or_product_signal_restored_from_source_log | 10 |
| agent_infrastructure_or_orchestration_role | 10 |
...
> 注意：地图 Role 中标为“很可能当前有效”的记录，仍可能因为公开发布时的期限、访问或结构门而没有进入 911 条当前岗位；求职检索应以当前岗位视图为准。
...
| 103 | 百度 AIDU | Baidu / 百度 | 中国 | 2 | 0 | — | 算法、研究与模型 1；工程与应用开发 1 | `TEAM-DBE946C652808DAE` |
...
| 114 | ByteDance / 字节跳动 | ByteDance / 字节跳动 | 中国 | 2 | 0 | — | 评测、测试与质量 2 | `TEAM-9AA5CB6DF0FA1643` |
...
| 139 | TRAE / 字节跳动 | ByteDance / 字节跳动 | 中国 | 1 | 0 | — | 评测、测试与质量 1 | `TEAM-A1322C05FE767DB7` |
...
| 143 | 字节跳动 Data | ByteDance / 字节跳动 | 中国 | 1 | 0 | — | 工程与应用开发 1 | `TEAM-CF56CBF2327EC9DE` |
| 144 | 字节跳动 Seed | ByteDance / 字节跳动 | 中国 | 0 | 0 | — | — | `TEAM-60054AA9F7E08A77` |
| 145 | 字节跳动 安全与风控 | ByteDance / 字节跳动 | 中国 | 1 | 0 | — | 安全、治理与合规 1 | `TEAM-CA95A661F4D60003` |
...
| 189 | DeepSeek / 杭州深度求索 | DeepSeek / 深度求索 | 中国 | 10 | 0 | — | 产品与设计 3；平台、基础设施与数据 3；算法、研究与模型 2；客户解决方案与交付 1；工程与应用开发 1 | `TEAM-3A8DB7932D55A6AB` |
| 190 | MetaGPT / DeepWisdom / FoundationAgents | DeepWisdom / FoundationAgents | 中国 | 0 | 0 | — | — | `TEAM-E0DFA34077B30B25` |
| 191 | Desay SV / 惠州市德赛西威汽车电子股份有限公司 | Desay SV / 惠州市德赛西威汽车电子股份有限公司 | 中国 | 4 | 4 | 平台、基础设施与数据 2；客户解决方案与交付 1；算法、研究与模型 1 | 平台、基础设施与数据 2；客户解决方案与交付 1；算法、研究与模型 1 | `TEAM-7850261E00ECC2F3` |
...
| 302 | NIO / 蔚来 | NIO / 蔚来 | 中国 | 86 | 62 | 算法、研究与模型 16；产品与设计 15；工程与应用开发 14；客户解决方案与交付 8；安全、治理与合规 5；平台、基础设施与数据 2；其他或边界岗位 2 | 算法、研究与模型 23；产品与设计 20；工程与应用开发 19；客户解决方案与交付 9；安全、治理与合规 8；平台、基础设施与数据 3；评测、测试与质量 2；其他或边界岗位 2 | `TEAM-C4A36E8C44F675DF` |
...
| 324 | QCraft / 轻舟智航 | QCraft / 轻舟智航 | 中国 | 0 | 0 | — | — | `TEAM-3450E800065CFFF6` |
...
| 369 | 腾讯 智能助手 | Tencent / 腾讯 | 中国 | 1 | 0 | — | 产品与设计 1 | `TEAM-7B152602A45A8F6F` |
...
| 393 | Xiaohongshu | Xiaohongshu / 小红书 | 中国 | 2 | 0 | — | 产品与设计 2 | `TEAM-B8A776987CFE3B07` |
| 394 | Xiaohongshu / RedNote | Xiaohongshu / 小红书 | 中国 | 1 | 1 | 算法、研究与模型 1 | 算法、研究与模型 1 | `TEAM-5F1327605A1E5535` |
| 395 | 小红书 | Xiaohongshu / 小红书 | 中国 | 2 | 0 | — | 算法、研究与模型 1；工程与应用开发 1 | `TEAM-76D29010587E10E4` |
...
| 685 | 经纬恒润 Hirain | 经纬恒润 Hirain | 中国 | 1 | 0 | — | 工程与应用开发 1 | `TEAM-B525092E9951EDA2` |
...
| 690 | 莫干山地信实验室 | 莫干山地信实验室 | 中国 | 1 | 0 | — | 客户解决方案与交付 1 | `TEAM-97C4CEDDDA6CC2BD` |
...
| 741 | Advisor360° | Advisor360° | 美国 | 0 | 0 | — | — | `TEAM-9D4092C167603877` |
| 742 | Aeris Communications | Aeris Communications | 美国 | 0 | 0 | — | — | `TEAM-01A6218D53F838CC` |
...
| 747 | DeepLearning.AI / Context Hub | AI Fund | 美国 | 0 | 0 | — | — | `TEAM-9BDB15FE3D2E738E` |
...
| 752 | Alaro | Alaro | 美国 | 0 | 0 | — | — | `TEAM-5A10C3088E1121F6` |
| 753 | Albert Invent | Albert Invent | 美国 | 0 | 0 | — | — | `TEAM-8A0A37E491D07418` |
| 754 | Aline | Aline | 美国 | 0 | 0 | — | — | `TEAM-4B30A2EF682EB8FE` |
...
| 762 | Google | Alphabet / Google | 美国 | 4 | 0 | — | 客户解决方案与交付 3；工程与应用开发 1 | `TEAM-085CF1D5BF408EA0` |
| 763 | Waymo | Alphabet / Google | 美国 | 0 | 0 | — | — | `TEAM-CF068A3AAF6D296A` |
| 764 | Alphawatch AI | Alphawatch AI | 美国 | 0 | 0 | — | — | `TEAM-637C34B0E21C0E11` |
...
| 798 | Ariso | Ariso | 美国 | 0 | 0 | — | — | `TEAM-2E8FE114F8B33769` |
...
| 803 | ARSIEM Corporation | ARSIEM Corporation | 美国 | 0 | 0 | — | — | `TEAM-54E3BBA678037B8B` |
| 804 | Articul8 AI | Articul8 AI | 美国 | 0 | 0 | — | — | `TEAM-104A59F429C17DCE` |
| 805 | Arva AI | Arva AI | 美国 | 0 | 0 | — | — | `TEAM-4F14482C757253D3` |
| 806 | Asha Health | Asha Health | 美国 | 0 | 0 | — | — | `TEAM-F55B5D7E4BBB4F7D` |
| 807 | Assembled | Assembled | 美国 | 0 | 0 | — | — | `TEAM-BAFC4D65D2C53B38` |
| 808 | Astraea | Astraea | 美国 | 0 | 0 | — | — | `TEAM-46E23C5007A1BC08` |
| 809 | Atlassian | Atlassian | 美国 | 2 | 0 | — | 客户解决方案与交付 1；其他或边界岗位 1 | `TEAM-7EA3DF1145E13AB8` |
| 810 | Atomic Object | Atomic Object | 美国 | 0 | 0 | — | — | `TEAM-5326263EA28E2C7B` |
| 811 | Atria Health and Research Institute | Atria Health and Research Institute | 美国 | 0 | 0 | — | — | `TEAM-3726905310E33DF6` |
...
| 821 | Avalara | Avalara | 美国 | 0 | 0 | — | — | `TEAM-31C4A65D730EA4FF` |
| 822 | Aware Health | Aware Health | 美国 | 0 | 0 | — | — | `TEAM-16114EB719A5808B` |
| 823 | Baselayer | Baselayer | 美国 | 0 | 0 | — | — | `TEAM-346EF48EDAED5880` |
| 824 | Bay Cities Container | Bay Cities Container | 美国 | 0 | 0 | — | — | `TEAM-FCA0A6046182F722` |
| 825 | BCU | BCU | 美国 | 0 | 0 | — | — | `TEAM-67D7A10EEC4A98F7` |
| 826 | BDIPlus | BDIPlus | 美国 | 0 | 0 | — | — | `TEAM-7FF9DD3DA69FAB7A` |
| 827 | Belay Technologies | Belay Technologies | 美国 | 0 | 0 | — | — | `TEAM-4C9DF10D8686EEA3` |
| 828 | GEICO | Berkshire Hathaway | 美国 | 0 | 0 | — | — | `TEAM-2824F6BC9CE5367C` |
| 829 | BIK | BIK | 美国 | 0 | 0 | — | — | `TEAM-DCEC6851D574158C` |
| 830 | BioStack Platforms | BioStack Platforms | 美国 | 0 | 0 | — | — | `TEAM-0032267A8833B692` |
...
| 847 | Burq, Inc. | Burq, Inc. | 美国 | 0 | 0 | — | — | `TEAM-C72209874334B7CB` |
| 848 | C the Signs | C the Signs | 美国 | 0 | 0 | — | — | `TEAM-32225CADB23144E6` |
| 849 | C2 Labs, Inc. | C2 Labs, Inc. | 美国 | 0 | 0 | — | — | `TEAM-59827D007ED8A290` |
| 850 | C3 AI | C3 AI | 美国 | 0 | 0 | — | — | `TEAM-41F73149C86E9A28` |
| 851 | Cain Watters & Associates | Cain Watters & Associates | 美国 | 0 | 0 | — | — | `TEAM-DF8A24BA36126886` |
| 852 | Cair Health | Cair Health | 美国 | 0 | 0 | — | — | `TEAM-D5F9A7F021CAA665` |
| 853 | Callab AI | Callab AI | 美国 | 0 | 0 | — | — | `TEAM-386FD671DFE69A61` |
| 854 | candidate.fyi | candidate.fyi | 美国 | 0 | 0 | — | — | `TEAM-C258E5AFBF8C1D4C` |
...
| 857 | Cardinal | Cardinal | 美国 | 0 | 0 | — | — | `TEAM-E1968090CAA7056C` |
| 858 | Careforce | Careforce | 美国 | 0 | 0 | — | — | `TEAM-6933DC6D237364F2` |
| 859 | CarMax | CarMax | 美国 | 0 | 0 | — | — | `TEAM-F47AF4586E763872` |
| 860 | Casco | Casco | 美国 | 0 | 0 | — | — | `TEAM-6022CD924016471D` |
| 861 | Catena | Catena | 美国 | 0 | 0 | — | — | `TEAM-223BA09C2824CC00` |
| 862 | Cato Institute | Cato Institute | 美国 | 0 | 0 | — | — | `TEAM-FD9A9E02388EF851` |
| 863 | CBT | CBT | 美国 | 0 | 0 | — | — | `TEAM-83E84DD85BB7F869` |
...
| 867 | CertiK | CertiK | 美国 | 0 | 0 | — | — | `TEAM-71B90E23FB0D0348` |
...
| 871 | Charles River Associates | Charles River Associates | 美国 | 0 | 0 | — | — | `TEAM-76BCA7D5080F852A` |
| 872 | Chasi | Chasi | 美国 | 0 | 0 | — | — | `TEAM-E172B9E1D2F9E6A1` |
| 873 | Cheiron | Cheiron | 美国 | 0 | 0 | — | — | `TEAM-21D8711C1B59EEFD` |
| 874 | Cherry Bekaert | Cherry Bekaert | 美国 | 0 | 0 | — | — | `TEAM-0689B47C9AD089BE` |
| 875 | ChipAgents | ChipAgents | 美国 | 0 | 0 | — | — | `TEAM-93FE6417612CC701` |
| 876 | Chroma | Chroma | 美国 | 0 | 0 | — | — | `TEAM-AEC727FB241AD666` |
| 877 | Circle Logistics | Circle Logistics | 美国 | 0 | 0 | — | — | `TEAM-CB1A612FAD12E317` |
...
| 897 | Composio | Composio | 美国 | 0 | 0 | — | — | `TEAM-E224E19C314CFEAA` |
...
| 909 | Cranston AI | Cranston AI | 美国 | 0 | 0 | — | — | `TEAM-FA81F968BC479DA4` |
...
| 912 | CrowdStrike | CrowdStrike | 美国 | 0 | 0 | — | — | `TEAM-2CAFCC0F09BEBF63` |
| 913 | Crunchyroll | Crunchyroll | 美国 | 0 | 0 | — | — | `TEAM-5498DE1FF49F6947` |
| 914 | Cua | Cua | 美国 | 0 | 0 | — | — | `TEAM-FB018B485FE56DE3` |
...
| 918 | Dataleap | Dataleap | 美国 | 0 | 0 | — | — | `TEAM-33710F889DBBF1EE` |
...
| 935 | DeVry University | DeVry University | 美国 | 0 | 0 | — | — | `TEAM-D44F484F107704AC` |
| 936 | Discovered Materials | Discovered Materials | 美国 | 0 | 0 | — | — | `TEAM-830C6CE187AD0583` |
| 937 | Distru | Distru | 美国 | 0 | 0 | — | — | `TEAM-A0696C641AD75A38` |
| 938 | DocVerify | DocVerify | 美国 | 1 | 0 | — | 工程与应用开发 1 | `TEAM-48D1B1BC300F0555` |
| 939 | DomainTools | DomainTools | 美国 | 0 | 0 | — | — | `TEAM-D7A9713AF2C6FBDC` |
| 940 | Doss | Doss | 美国 | 0 | 0 | — | — | `TEAM-408529EBC4F1F7EB` |
| 941 | Double Blind Bio | Double Blind Bio | 美国 | 0 | 0 | — | — | `TEAM-C8B96E9A3F467DCF` |
...
| 945 | ego / Ego AI | ego / Ego AI | 美国 | 0 | 0 | — | — | `TEAM-CF8C414B446EB7F6` |
...
| 948 | Elixirr Digital | Elixirr | 美国 | 0 | 0 | — | — | `TEAM-82A16882592804C7` |
| 949 | Eliza | Eliza | 美国 | 0 | 0 | — | — | `TEAM-C2C8233BEFFBAAAF` |
...
| 957 | Espa Labs | Espa Labs | 美国 | 0 | 0 | — | — | `TEAM-9CDB0F2FDD7B394C` |
...
| 961 | Expedia Group | Expedia Group | 美国 | 0 | 0 | — | — | `TEAM-661C38562FA6471F` |
...
| 972 | FinThrive | FinThrive | 美国 | 0 | 0 | — | — | `TEAM-72548895BE9C8AC8` |
| 973 | Fisher Phillips LLP | Fisher Phillips LLP | 美国 | 0 | 0 | — | — | `TEAM-648F14B9FDE89672` |
| 974 | Flagship Pioneering / Pioneering Intelligence | Flagship Pioneering | 美国 | 0 | 0 | — | — | `TEAM-9402AF7091F5D867` |
| 975 | Flair Labs | Flair Labs | 美国 | 0 | 0 | — | — | `TEAM-67DD25A4628F75BE` |
...
| 979 | forgd, inc. | forgd, inc. | 美国 | 0 | 0 | — | — | `TEAM-BCAE6B530D0D582C` |
...
| 983 | Fullthrottle.ai | Fullthrottle.ai | 美国 | 0 | 0 | — | — | `TEAM-423A984676AB460C` |
| 984 | FurtherAI | FurtherAI | 美国 | 0 | 0 | — | — | `TEAM-F76E2A020C2DE9EE` |
| 985 | FuseAI | FuseAI | 美国 | 0 | 0 | — | — | `TEAM-00342A86C8014AEC` |
| 986 | Future Works | Future Works | 美国 | 0 | 0 | — | — | `TEAM-559C41620622193A` |
...
| 999 | Glean | Glean | 美国 | 3 | 0 | — | 工程与应用开发 2；产品与设计 1 | `TEAM-67B1F196D17FDDE5` |
| 1000 | Glen | Glen | 美国 | 0 | 0 | — | — | `TEAM-55436E36464BE8DF` |
| 1001 | GodHands | GodHands | 美国 | 0 | 0 | — | — | `TEAM-37F673043A320133` |
| 1002 | goodfin | goodfin | 美国 | 0 | 0 | — | — | `TEAM-43D6B65F495C4DF6` |
| 1003 | Govly, Inc. | Govly, Inc. | 美国 | 0 | 0 | — | — | `TEAM-7D1F2FD83F3D09E6` |
...
| 1007 | Greater New York Mutual Insurance Company | Greater New York Mutual Insurance Company | 美国 | 0 | 0 | — | — | `TEAM-6AAB78F4E087B85B` |
| 1008 | Greptile | Greptile | 美国 | 8 | 8 | 平台、基础设施与数据 3；商务、市场与合作 2；产品与设计 1；客户解决方案与交付 1；算法、研究与模型 1 | 平台、基础设施与数据 3；商务、市场与合作 2；产品与设计 1；客户解决方案与交付 1；算法、研究与模型 1 | `TEAM-AA286618731A7B97` |
| 1009 | Stratus | GTP Software, Inc. | 美国 | 0 | 0 | — | — | `TEAM-CCC28B9E90A24167` |
| 1010 | Guide Labs | Guide Labs | 美国 | 0 | 0 | — | — | `TEAM-EEF0DBDD453CD8BF` |
| 1011 | Guild.ai | Guild.ai | 美国 | 1 | 0 | — | 产品与设计 1 | `TEAM-FA32B955448DD636` |
| 1012 | Halluminate | Halluminate | 美国 | 0 | 0 | — | — | `TEAM-C78E9D5CECC39AC4` |
| 1013 | HappyRobot | HappyRobot | 美国 | 7 | 5 | 评测、测试与质量 2；平台、基础设施与数据 2；商务、市场与合作 1 | 评测、测试与质量 2；商务、市场与合作 2；平台、基础设施与数据 2；产品与设计 1 | `TEAM-327C1F0DE62CBF74` |
| 1014 | hardware intelligence | hardware intelligence | 美国 | 0 | 0 | — | — | `TEAM-284FBE7BBB12419B` |
| 1015 | Harper | Harper | 美国 | 0 | 0 | — | — | `TEAM-9D1302E24CDC6586` |
| 1016 | Harvard University | Harvard University | 美国 | 0 | 0 | — | — | `TEAM-AA138E5BF5F7DF9B` |
| 1017 | Haven | Haven | 美国 | 0 | 0 | — | — | `TEAM-FF93041FC22A5031` |
...
| 1023 | Hexion Inc. | Hexion Inc. | 美国 | 0 | 0 | — | — | `TEAM-4A9659E8AC7C647E` |
| 1024 | HeyGen | HeyGen | 美国 | 1 | 1 | 平台、基础设施与数据 1 | 平台、基础设施与数据 1 | `TEAM-914EDB1F2ACF5317` |
| 1025 | High Side Technology | High Side Technology | 美国 | 0 | 0 | — | — | `TEAM-7E69ED7E4133EC75` |
| 1026 | Highspot | Highspot | 美国 | 0 | 0 | — | — | `TEAM-16436F886A9BD3C7` |
| 1027 | Hobbes | Hobbes | 美国 | 0 | 0 | — | — | `TEAM-41CA882749F865CA` |
...
| 1032 | Humwork | Humwork | 美国 | 0 | 0 | — | — | `TEAM-D2AD61DB8C9BED9E` |
...
| 1035 | Hyperspell | Hyperspell | 美国 | 0 | 0 | — | — | `TEAM-2E6B73090B62C0F9` |
| 1036 | Hyundai Capital America | Hyundai Capital America | 美国 | 0 | 0 | — | — | `TEAM-870D647779BFDB45` |
| 1037 | ID.me | ID.me | 美国 | 0 | 0 | — | — | `TEAM-CFEE8F75E68E40E7` |
| 1038 | Identity Digital | Identity Digital | 美国 | 0 | 0 | — | — | `TEAM-0D80818D648580BD` |
| 1039 | IFS | IFS | 美国 | 5 | 4 | 算法、研究与模型 2；产品与设计 1；客户解决方案与交付 1 | 产品与设计 2；算法、研究与模型 2；客户解决方案与交付 1 | `TEAM-18B8A4B99524EC7F` |
...
| 1043 | Index Analytics LLC | Index Analytics LLC | 美国 | 0 | 0 | — | — | `TEAM-5427376B4A4DC4DF` |
| 1044 | Infer | Infer | 美国 | 0 | 0 | — | — | `TEAM-C296B58149874037` |
| 1045 | Inferact | Inferact | 美国 | 0 | 0 | — | — | `TEAM-47E7C4C6201C498A` |
| 1046 | Influur | Influur | 美国 | 0 | 0 | — | — | `TEAM-5847CE6A7A4F2B9E` |
| 1047 | InRule Technology, Inc. | InRule Technology, Inc. | 美国 | 0 | 0 | — | — | `TEAM-8F077B293D842CD3` |
...
| 1061 | Juicebox | Juicebox | 美国 | 6 | 6 | 商务、市场与合作 2；客户解决方案与交付 2；安全、治理与合规 1；平台、基础设施与数据 1 | 商务、市场与合作 2；客户解决方案与交付 2；安全、治理与合规 1；平台、基础设施与数据 1 | `TEAM-E74F634204F775B9` |
...
| 1066 | Kastle | Kastle | 美国 | 0 | 0 | — | — | `TEAM-BC75C3A3F330A0E4` |
| 1067 | Keycard Labs | Keycard Labs | 美国 | 0 | 0 | — | — | `TEAM-6EE44F374C78AC5D` |
...
| 1075 | Knotch, Inc. | Knotch, Inc. | 美国 | 0 | 0 | — | — | `TEAM-8DAA7C390C69C3EF` |
...
| 1084 | LangChain | LangChain | 美国 | 0 | 0 | — | — | `TEAM-441D6B22770E7A85` |
| 1085 | Layerup | Layerup | 美国 | 0 | 0 | — | — | `TEAM-172CBB26FB16DAFE` |
...
| 1094 | Liner | Liner | 美国 | 11 | 11 | 运营、项目与职能 6；评测、测试与质量 2；商务、市场与合作 2；产品与设计 1 | 运营、项目与职能 6；评测、测试与质量 2；商务、市场与合作 2；产品与设计 1 | `TEAM-567669C2033C7C30` |
...
| 1104 | Lumari | Lumari | 美国 | 0 | 0 | — | — | `TEAM-22339A98F83A9D18` |
| 1105 | Luxury Presence | Luxury Presence | 美国 | 0 | 0 | — | — | `TEAM-7F8A2BD624DD36CD` |
...
| 1110 | MacStadium | MacStadium | 美国 | 0 | 0 | — | — | `TEAM-EE15635BA1D4BB53` |
...
| 1114 | Manicule | Manicule | 美国 | 0 | 0 | — | — | `TEAM-FB7BFD64012E9C8F` |
| 1115 | Manufact (formerly mcp-use) | Manufact (formerly mcp-use) | 美国 | 1 | 1 | 评测、测试与质量 1 | 评测、测试与质量 1 | `TEAM-E763AFBE3EA02D89` |
...
| 1118 | Misfits & Machines | Marketing Architects | 美国 | 0 | 0 | — | — | `TEAM-4A9A727D36E79609` |
...
| 1120 | Matrices | Matrices | 美国 | 0 | 0 | — | — | `TEAM-D95DB777040B5504` |
...
| 1123 | Meeting Tomorrow | Meeting Tomorrow | 美国 | 0 | 0 | — | — | `TEAM-E948D36C4B0DBF1A` |
| 1124 | Memory Store | Memory Store | 美国 | 0 | 0 | — | — | `TEAM-0F85B636A1E0C67D` |
| 1125 | Intermolecular / EMD Electronics | Merck KGaA | 美国 | 0 | 0 | — | — | `TEAM-F74BE0FFB1B674C8` |
| 1126 | Meridian | Meridian | 美国 | 0 | 0 | — | — | `TEAM-95E7487C89A7CBD2` |
| 1127 | Micron Technology | Micron Technology | 美国 | 0 | 0 | — | — | `TEAM-741712D4388326C5` |
| 1128 | Mimecast | Mimecast | 美国 | 0 | 0 | — | — | `TEAM-6AD66C345246FB8C` |
...
| 1138 | Momentic | Momentic | 美国 | 1 | 1 | 商务、市场与合作 1 | 商务、市场与合作 1 | `TEAM-6125BA7381E8850B` |
| 1139 | Monte Carlo | Monte Carlo | 美国 | 0 | 0 | — | — | `TEAM-54691A47600A7124` |
| 1140 | Mor Furniture For Less Inc. | Mor Furniture For Less Inc. | 美国 | 0 | 0 | — | — | `TEAM-063DE3F3BDDCC7D1` |
| 1141 | Mount | Mount | 美国 | 0 | 0 | — | — | `TEAM-48711AE0E2A45BFF` |
...
| 1144 | Mutual of Omaha | Mutual of Omaha | 美国 | 0 | 0 | — | — | `TEAM-3A78F5B5991D148A` |
| 1145 | Nango | Nango | 美国 | 0 | 0 | — | — | `TEAM-30FF2FCAAB0F4850` |
| 1146 | Narrative | Narrative | 美国 | 0 | 0 | — | — | `TEAM-88260DBC7E8ECD3E` |
| 1147 | Naver U.Hub INC | NAVER | 美国 | 0 | 0 | — | — | `TEAM-9E13A1985648BA3F` |
...
| 1155 | NovaVoxx AI | NovaVoxx AI | 美国 | 1 | 0 | — | 工程与应用开发 1 | `TEAM-4A56A5E62CB980BF` |
...
| 1158 | Nutanix | Nutanix | 美国 | 0 | 0 | — | — | `TEAM-0D2DBE4C3A9333A9` |
...
| 1170 | OPPO US Research Center / InnoPeak | OPPO | 美国 | 0 | 0 | — | — | `TEAM-4B3A5805D1736436` |
...
| 1173 | Origin | Origin | 美国 | 0 | 0 | — | — | `TEAM-DEEAD9A1F39E88D7` |
| 1174 | Orkes | Orkes | 美国 | 0 | 0 | — | — | `TEAM-1BB8E654B527E7E5` |
| 1175 | Roamly Labs / The Ride Platform | Outdoorsy Group | 美国 | 0 | 0 | — | — | `TEAM-F72DF3F46A20907D` |
| 1176 | Outreach | Outreach | 美国 | 0 | 0 | — | — | `TEAM-B169E4BC9EEB02D7` |
...
| 1187 | Parloa | Parloa | 美国 | 0 | 0 | — | — | `TEAM-08F8201B96D6A77E` |
| 1188 | Pasito | Pasito | 美国 | 0 | 0 | — | — | `TEAM-A30C0BE17F6E05E8` |
| 1189 | Patch My PC | Patch My PC | 美国 | 0 | 0 | — | — | `TEAM-B7EF8F81BB2CEE40` |
...
| 1202 | Planera | Planera | 美国 | 0 | 0 | — | — | `TEAM-9741280473BCD062` |
| 1203 | Plot Technologies, Inc. | Plot Technologies, Inc. | 美国 | 0 | 0 | — | — | `TEAM-5829AF45C103F2C0` |
...
| 1207 | Pond & Company / Enercon Services | Pond & Company / Enercon Services | 美国 | 0 | 0 | — | — | `TEAM-89E7CC9E7630FC64` |
| 1208 | Postman | Postman | 美国 | 0 | 0 | — | — | `TEAM-F101A6DC9BD315D9` |
...
| 1217 | Prototyping.io | Prototyping.io | 美国 | 0 | 0 | — | — | `TEAM-C3FA9D286FEB60EB` |
| 1218 | Prox | Prox | 美国 | 0 | 0 | — | — | `TEAM-E6E65262CDDBD790` |
| 1219 | Proximitty | Proximitty | 美国 | 0 | 0 | — | — | `TEAM-B5A6626D7B3AA8D5` |
| 1220 | PTP | PTP | 美国 | 0 | 0 | — | — | `TEAM-63A4C2A5EA224033` |
| 1221 | PulsePoint | PulsePoint | 美国 | 0 | 0 | — | — | `TEAM-05FDF0F0759F0D85` |
| 1222 | PwC US | PwC US | 美国 | 0 | 0 | — | — | `TEAM-FE83A45023E90A6C` |
| 1223 | Qualtrics | Qualtrics | 美国 | 0 | 0 | — | — | `TEAM-ADCF62B1461BCB0F` |
| 1224 | RamAIn | RamAIn | 美国 | 0 | 0 | — | — | `TEAM-B28A014BA9A0FFEA` |
| 1225 | Rational | Rational | 美国 | 0 | 0 | — | — | `TEAM-F5DA0D268B964AD9` |
| 1226 | Re:Build Manufacturing / Reflow | Re:Build Manufacturing | 美国 | 0 | 0 | — | — | `TEAM-0B090027B508CC93` |
...
| 1230 | Refactor | Refactor | 美国 | 0 | 0 | — | — | `TEAM-0FAF84AA06E01109` |
| 1231 | ReFiBuy, Inc. | ReFiBuy, Inc. | 美国 | 0 | 0 | — | — | `TEAM-2E3D6846B07FECA4` |
| 1232 | Reforged Labs | Reforged Labs | 美国 | 0 | 0 | — | — | `TEAM-FB94D189FBE2E1A2` |
| 1233 | Regal | Regal | 美国 | 0 | 0 | — | — | `TEAM-A32BB80DFADE1A6F` |
| 1234 | Relari | Relari | 美国 | 0 | 0 | — | — | `TEAM-2D72D66D258FE6F0` |
| 1235 | Relevance AI | Relevance AI | 美国 | 0 | 0 | — | — | `TEAM-BD8C5A1932A48834` |
| 1236 | Renesas Electronics | Renesas Electronics | 美国 | 1 | 1 | 工程与应用开发 1 | 工程与应用开发 1 | `TEAM-CF6ADCD824285DED` |
| 1237 | Renew Home | Renew Home | 美国 | 0 | 0 | — | — | `TEAM-71F9C0B9FC3727A6` |
| 1238 | RentAHuman | RentAHuman | 美国 | 0 | 0 | — | — | `TEAM-5F0B671725D50B65` |
| 1239 | Replicas | Replicas | 美国 | 0 | 0 | — | — | `TEAM-33C949FF98FEFB71` |
| 1240 | Rescript | Rescript | 美国 | 0 | 0 | — | — | `TEAM-8A65048DE05DF075` |
| 1241 | Resorius / 리소리우스 | Resorius / 리소리우스 | 美国 | 0 | 0 | — | — | `TEAM-8ED2C41CA7837F6B` |
| 1242 | Restate | Restate | 美国 | 0 | 0 | — | — | `TEAM-D06ABFE7EFAC7F25` |
| 1243 | Resultant | Resultant | 美国 | 0 | 0 | — | — | `TEAM-58954907EFF3DA89` |
| 1244 | Revion | Revion | 美国 | 0 | 0 | — | — | `TEAM-9997587D5BE1DCE2` |
| 1245 | Revnu | Revnu | 美国 | 0 | 0 | — | — | `TEAM-9E1C7C48FBE89FA4` |
| 1246 | Revyl | Revyl | 美国 | 0 | 0 | — | — | `TEAM-F71B02E220FAFF50` |
...
| 1250 | Ripple | Ripple | 美国 | 0 | 0 | — | — | `TEAM-1BB8C95796BC9070` |
...
| 1255 | Rovi Health | Rovi Health | 美国 | 0 | 0 | — | — | `TEAM-0FA075D6B8D464C5` |
| 1256 | Rownd | Rownd | 美国 | 0 | 0 | — | — | `TEAM-3C030821DD3DFBA1` |
| 1257 | Ruma Care | Ruma Care | 美国 | 0 | 0 | — | — | `TEAM-6416B0B13DEC015A` |
...
| 1260 | Sage Care | Sage Care | 美国 | 0 | 0 | — | — | `TEAM-ECB4E6693CF9EBC8` |
...
| 1268 | screenpipe | screenpipe | 美国 | 0 | 0 | — | — | `TEAM-115C0A72563C9FC8` |
| 1269 | SDL / GovPilot ecosystem | SDL / GovPilot ecosystem | 美国 | 0 | 0 | — | — | `TEAM-0D21D5920364D353` |
| 1270 | Sekai | Sekai | 美国 | 0 | 0 | — | — | `TEAM-1C25079C7A062B39` |
| 1271 | SellScale | SellScale | 美国 | 0 | 0 | — | — | `TEAM-740915524E6E263B` |
| 1272 | Moveworks | ServiceNow | 美国 | 2 | 0 | — | 客户解决方案与交付 1；工程与应用开发 1 | `TEAM-431EEBA48C5B0A43` |
| 1273 | ServiceNow | ServiceNow | 美国 | 45 | 42 | 工程与应用开发 17；算法、研究与模型 7；安全、治理与合规 6；商务、市场与合作 5；产品与设计 4；其他或边界岗位 2；客户解决方案与交付 1 | 工程与应用开发 18；算法、研究与模型 7；安全、治理与合规 6；产品与设计 6；商务、市场与合作 5；其他或边界岗位 2；客户解决方案与交付 1 | `TEAM-EC30E55EE8695AA4` |
...
| 1283 | Sixfold | Sixfold | 美国 | 0 | 0 | — | — | `TEAM-81CE721AEB2006EF` |
...
| 1293 | Software Defined Automation | Software Defined Automation | 美国 | 1 | 1 | 工程与应用开发 1 | 工程与应用开发 1 | `TEAM-0AB7AA339624B97C` |
| 1294 | Solum Health | Solum Health | 美国 | 0 | 0 | — | — | `TEAM-A1CA9340F4CA9C58` |
| 1295 | Sourcebot | Sourcebot | 美国 | 0 | 0 | — | — | `TEAM-BE8F243CBCCD2401` |
| 1296 | preloop / preloop | Spacecode.AI, Inc. | 美国 | 0 | 0 | — | — | `TEAM-DC6F6D77AB19A414` |
| 1297 | Spur | Spur | 美国 | 0 | 0 | — | — | `TEAM-D2DF1FA39240A80F` |
...
| 1305 | Strata Decision Technology | Strata Decision Technology | 美国 | 0 | 0 | — | — | `TEAM-5A34E0B37F3A7248` |
| 1306 | Structured AI | Structured AI | 美国 | 0 | 0 | — | — | `TEAM-18D3A2ACF689BA0D` |
| 1307 | Substrate | Substrate | 美国 | 0 | 0 | — | — | `TEAM-DD8D2025D2E97AEE` |
| 1308 | Sully.ai | Sully.ai | 美国 | 0 | 0 | — | — | `TEAM-130C491599B86CF0` |
| 1309 | Super.com | Super.com | 美国 | 0 | 0 | — | — | `TEAM-0938544CB90CF5CB` |
| 1310 | Superconductor | Superconductor | 美国 | 0 | 0 | — | — | `TEAM-27925BF6E4A7BE0D` |
...
| 1318 | Talcott Financial Group | Talcott Financial Group | 美国 | 0 | 0 | — | — | `TEAM-23946CFDBE8F1BFD` |
| 1319 | Taxbit | Taxbit | 美国 | 1 | 1 | 工程与应用开发 1 | 工程与应用开发 1 | `TEAM-57799B4AC6B45F06` |
| 1320 | Tebra | Tebra | 美国 | 0 | 0 | — | — | `TEAM-56E05C60970F21E9` |
| 1321 | Temper | Temper | 美国 | 0 | 0 | — | — | `TEAM-162B81219CD88E4B` |
| 1322 | TesterArmy | TesterArmy | 美国 | 0 | 0 | — | — | `TEAM-843E82CA4FA5FBCA` |
| 1323 | The General Intelligence Company of New York | The General Intelligence Company of New York | 美国 | 0 | 0 | — | — | `TEAM-AD2FB280FC7FBA37` |
...
| 1332 | Tivara | Tivara | 美国 | 0 | 0 | — | — | `TEAM-40EE790590CDA6FC` |
...
| 1353 | Udacity | Udacity | 美国 | 0 | 0 | — | — | `TEAM-478E90CAAB0D4B76` |
...
| 1384 | Vista Fulfillment Group | Vista Fulfillment Group | 美国 | 0 | 0 | — | — | `TEAM-0BCB4B899F38568F` |
| 1385 | Voiceops | Voiceops | 美国 | 0 | 0 | — | — | `TEAM-4CEF3E40D1538AFE` |
...
| 1391 | VOYGR | VOYGR | 美国 | 0 | 0 | — | — | `TEAM-344CBF0E9D443FDF` |
| 1392 | Vulcan Technologies | Vulcan Technologies | 美国 | 0 | 0 | — | — | `TEAM-A2793C43AA3EE227` |
| 1393 | Wato | Wato | 美国 | 0 | 0 | — | — | `TEAM-819D0A177B2B9CC8` |
| 1394 | Wellmark, Inc. | Wellmark, Inc. | 美国 | 0 | 0 | — | — | `TEAM-12C3979F0086A08B` |
| 1395 | Wells Fargo | Wells Fargo | 美国 | 0 | 0 | — | — | `TEAM-DBBBB19043303754` |
...
| 1404 | Wolfia | Wolfia | 美国 | 0 | 0 | — | — | `TEAM-5F9A0424F83D4586` |
...
| 1422 | AbbVie | AbbVie | 中国、美国 | 12 | 11 | 工程与应用开发 4；客户解决方案与交付 3；安全、治理与合规 2；产品与设计 1；其他或边界岗位 1 | 工程与应用开发 5；客户解决方案与交付 3；安全、治理与合规 2；产品与设计 1；其他或边界岗位 1 | `TEAM-9C57045FA4FFB418` |
| 1423 | Microsoft | Microsoft | 中国、美国 | 0 | 0 | — | — | `TEAM-B656B917C8BBBA70` |
